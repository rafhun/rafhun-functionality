 ...
 * Plugin URI: https://github.com/rafhun/rafhun-functionality-plugins
 * Description: A collection of usefule and typical WP optimizations  brought together in one plugin. Comment out everything you do no need to keep your code base clean. Add more partials where needed. Always make sure to keep theme related stuff in the functions.php file of your theme while whole page related stuff should be here. For now there are two plugins in this collection, an editor optimization and a category navigation one. More will follow.
 * Version: 0.1.0
 * Author: rafhun
